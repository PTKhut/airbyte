...
class JinjaInterpolation(Interpolation):
    ...
    def eval(
        self, input_str: str, config: Config, default: Optional[str] = None, valid_types: Optional[Tuple[Type]] = None, **additional_parameters
    ):
    ...
    def _literal_eval(self, result, valid_types: Optional[Tuple[Type]]):
        try:
            ...
            return result
        if valid_types and isinstance(evaluated, valid_types):
            return evaluated
