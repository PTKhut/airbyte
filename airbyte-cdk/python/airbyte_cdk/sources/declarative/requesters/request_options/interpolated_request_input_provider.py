...
from typing import Any, Mapping, Optional, Union, Tuple, Type
...
class InterpolatedRequestInputProvider:
    ...
    def eval_request_inputs(
        self, stream_state: StreamState, stream_slice: Optional[StreamSlice] = None, next_page_token: Mapping[str, Any] = None, valid_types: Tuple[Type] = None,
    ) -> Mapping[str, Any]:
        """
